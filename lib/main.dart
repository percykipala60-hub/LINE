...
void main() async {
  ...
  try {
    ...
    debugPrint(
      'Avertissement : Échec de l\'initialisation automatique de Supabase (URL/Clés par défaut) : $e',
    );
  }
  ...
  try {
    StripeService.instance.init(
      'pk_test_51TkDtL00389LZDsbTwJGsD3I94GKSZyKNEg7R6GGtH7NnVonRSw7IBEqsnvLsW596piwOTszczWr5VgrGQ5I9Oax000kUfzAt7',
    );
  } catch (e) {
  ...
  runApp(const ProviderScope(child: LineApp()));
}
