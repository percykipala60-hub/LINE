        ...
        if (selectedMethod == PaymentMethodType.mobileMoney) ...[
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text('Choisissez votre réseau :', style: theme.textTheme.bodyMedium),
                ...
                if (phoneController != null)
                  TextFormField(
                    ...
                    validator: (val) {
                      if (val == null || val.isEmpty) return 'Veuillez entrer votre numéro';
    ...
    return Card(
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              Icon(icon, size: 32, color: isSelected ? theme.colorScheme.primary : theme.iconTheme.color),
