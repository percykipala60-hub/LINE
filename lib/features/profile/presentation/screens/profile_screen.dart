    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildProfileItem(context, icon: Icons.inventory_2_outlined, title: 'Mes commandes'),
          _buildProfileItem(context, icon: Icons.favorite_border, title: 'Mes favoris'),
          const Divider(height: 32),
          _buildProfileItem(context, icon: Icons.settings_outlined, title: 'Paramètres du compte'),
          _buildProfileItem(context, icon: Icons.support_agent_outlined, title: 'Support clients'),
